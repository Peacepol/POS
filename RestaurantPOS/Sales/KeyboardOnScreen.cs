...
namespace AbleRetailPOS.Sales
{
    public partial class KeyboardOnScreen : Form
    {
        ...
        private void btnEndEdit_Click(object sender, EventArgs e)
        {
            if (txtValue.Text != "")
            {
                if (titlepage == "Change Quantity Value")
                {
                    pValue = string.Concat(txtValue.Text.Where(char.IsDigit));
                    //string strValue = string.Concat(txtValue.Text.Where(char.IsLetter));
