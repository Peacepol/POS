...
namespace AbleRetailPOS.Sales
{
    public partial class AmountPanel : Form
    {
        ...
        public void generateImage()
        {
            ...
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.Cash;
            }
            else if (txtPayment.Text == "Cheque")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.Cheque;
            }
            else if (txtPayment.Text == "Complimentary")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.business_and_finance;
            }
            else if (txtPayment.Text == "Credit Card")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.credit_card;
            }
            else if (txtPayment.Text == "Debit Card")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.pay;
            }
            else if (txtPayment.Text == "Direct Deposit")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.DirectDeposit;
            }
            else if (txtPayment.Text == "Eftpos")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.eftpos;
            }
            else if (txtPayment.Text == "GC")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.gift_card;
            }
            else if (txtPayment.Text == "Other")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.Others;
            }
            else if (txtPayment.Text == "Paypal")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.paypal;
            }
            else if (txtPayment.Text == "Salary Sacrifice")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.SalarySacrifice;
            }
            else if (txtPayment.Text == "Staff Deduction")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.staffDeduction;
            }
            else if (txtPayment.Text == "Voucher")
            {
                pbPaymentImage.Image = global::AbleRetailPOS.Properties.Resources.coupon;
            }
