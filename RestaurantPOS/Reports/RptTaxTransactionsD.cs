...
{
    public partial class RptTaxTransactionsD : Form
    {
        ...
        private void RptTaxTransactionsD_Load(object sender, EventArgs e)
        {
            if (!CanView)
            {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            acctlistparams.RptTitle = "Tax Transactions Detail";
        ...
        private void LoadReport()
        {
            ...
            try
            {
                ...
                string sql = "";
                sql = @"SELECT d.TaxCode, t.TaxCodeDescription, t.TaxPercentageRate,SaleValue,PurchaseValue, TaxCollected,TaxPaid,TransactionDate,TranID,TransactionNo,profilename from ( ";
                ...
                {
                    lRptFile = "TaxTransactionsDC.rpt";

                }
                else if (this.rdoP.Checked)
                {
                    lRptFile = "TaxTransactionsDP.rpt";
                }
                else
                {
                    lRptFile = "TaxTransactionsDCP.rpt";
                }
        ...
        private void btnDisplay_Click(object sender, EventArgs e)
        {
            ...
            {
                FormatGrid();
                if (this.rdoC.Checked)//Collected
                {
                    for (int x = 0; x < TbGrid.Rows.Count; x++)
                    {
                        DataRow dr = TbGrid.Rows[x];
                        if (lPrevItem != dr["TaxCode"].ToString().Trim() && lPrevItem != "")
                        {
                            RowArray = new string[9];
                            RowArray[1] = " TOTAL :";
                            RowArray[5] = TotalSValue(lPrevItem).ToString("C2");
                            RowArray[6] = TotalTaxCollected(lPrevItem).ToString("C2");
                        ...
                        if (lPrevItem != dr["TaxCode"].ToString().Trim())
                        {
                            ...
                            RowArray[1] = dr["TaxCodeDescription"].ToString() + " " + decimal.Parse(dr["TaxPercentageRate"].ToString()).ToString("P");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
                            RowArray = new string[9];
                            RowArray[2] = DateTime.Parse(dr["TransactionDate"].ToString()).ToString("MM/dd/yyyy");
                            RowArray[3] = dr["TransactionNo"].ToString();
                            RowArray[4] = dr["profilename"].ToString();
                            RowArray[5] = float.Parse(dr["SaleValue"].ToString()).ToString("C2");
                            RowArray[6] = float.Parse(dr["TaxCollected"].ToString()).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                        }
                        else
                        {
                        ...
                        if (TbRep.Rows.Count - 1 == x)
                        {
                            RowArray = new string[9];
                            RowArray[1] = " TOTAL :";
                            RowArray[5] = TotalSValue(dr["TaxCode"].ToString()).ToString("C2");
                            RowArray[6] = TotalTaxCollected(dr["TaxCode"].ToString()).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.BackColor = System.Drawing.Color.LightGray;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
                            ...
                            RowArray[5] = TotalSValue().ToString("C2");
                            RowArray[6] = TotalTaxCollected().ToString("C2");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.BackColor = System.Drawing.Color.LightGray;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
                ...
                else if (this.rdoP.Checked)//paid
                {
                    for (int x = 0; x < TbGrid.Rows.Count; x++)
                    {
                        DataRow dr = TbGrid.Rows[x];
                        if (lPrevItem != dr["TaxCode"].ToString().Trim() && lPrevItem != "")
                        {
                            RowArray = new string[9];
                            RowArray[1] = " TOTAL :";
                            RowArray[5] = TotalPValue(lPrevItem).ToString("C2");
                            RowArray[6] = TotalTaxPaid(lPrevItem).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.BackColor = System.Drawing.Color.LightGray;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
                        ...
                        if (lPrevItem != dr["TaxCode"].ToString().Trim())
                        {
                            ...
                            RowArray[3] = dr["TransactionNo"].ToString();
                            RowArray[4] = dr["profilename"].ToString();
                            RowArray[5] = float.Parse(dr["PurchaseValue"].ToString() == "" ? "0" : dr["PurchaseValue"].ToString()).ToString("C2");
                            RowArray[6] = float.Parse(dr["TaxPaid"].ToString() == "" ? "0" : dr["PurchaseValue"].ToString()).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                        }
                        else
                        {
                        ...
                        if (TbRep.Rows.Count - 1 == x)
                        {
                            RowArray = new string[9];
                            RowArray[1] = " TOTAL :";
                            RowArray[5] = TotalPValue(dr["TaxCode"].ToString()).ToString("C2");
                            ...
                            RowArray = new string[9];
                            RowArray[1] = "GRAND TOTAL :";
                            RowArray[5] = TotalPValue().ToString("C2");
                ...
                else
                {
                    for (int x = 0; x < TbGrid.Rows.Count; x++)
                    {
                        ...
                        if (lPrevItem != dr["TaxCode"].ToString().Trim() && lPrevItem != "")
                        {
                            ...
                            RowArray[1] = " TOTAL :";
                            RowArray[5] = TotalSValue(lPrevItem).ToString("C2");
                            RowArray[6] = TotalPValue(lPrevItem).ToString("C2");
                            RowArray[7] = TotalTaxCollected(lPrevItem).ToString("C2");
                            RowArray[8] = TotalTaxPaid(lPrevItem).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.BackColor = System.Drawing.Color.LightGray;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
                        ...
                        if (lPrevItem != dr["TaxCode"].ToString().Trim())
                        {
                            ...
                            RowArray[4] = dr["profilename"].ToString();
                            RowArray[5] = float.Parse(dr["SaleValue"].ToString()).ToString("C2");
                            RowArray[6] = float.Parse(dr["PurchaseValue"].ToString() == "" ? "0" : dr["PurchaseValue"].ToString()).ToString("C2");
                            RowArray[7] = float.Parse(dr["TaxCollected"].ToString() == "" ? "0" : dr["TaxCollected"].ToString()).ToString("C2");
                            RowArray[8] = float.Parse(dr["TaxPaid"].ToString() == "" ? "0" : dr["TaxPaid"].ToString()).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                        }
                        else
                        {
                        ...
                        if (TbRep.Rows.Count - 1 == x)
                        {
                            ...
                            RowArray[1] = " TOTAL :";
                            RowArray[5] = TotalSValue(dr["TaxCode"].ToString()).ToString("C2");
                            RowArray[6] = TotalPValue(dr["TaxCode"].ToString()).ToString("C2");
                            RowArray[7] = TotalTaxCollected(dr["TaxCode"].ToString()).ToString("C2");
                            RowArray[8] = TotalTaxPaid(dr["TaxCode"].ToString()).ToString("C2");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.BackColor = System.Drawing.Color.LightGray;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
                            ...
                            RowArray[1] = "GRAND TOTAL :";
                            RowArray[5] = TotalSValue().ToString("C2");
                            RowArray[6] = TotalPValue().ToString("C2");
                            RowArray[7] = TotalTaxCollected().ToString("C2");
                            RowArray[8] = TotalTaxPaid().ToString("C2");
                            dgReport.Rows.Add(RowArray);
                            rIndex = dgReport.Rows.Count - 1;
                            dgReport.Rows[rIndex].DefaultCellStyle.BackColor = System.Drawing.Color.LightGray;
                            dgReport.Rows[rIndex].DefaultCellStyle.Font = new System.Drawing.Font(dgReport.Font, FontStyle.Bold);
        ...
        void FormatGrid()
        {
            if (this.rdoC.Checked)
            {
                ...
                dgReport.Columns[2].Name = "Date";
                dgReport.Columns[3].Name = "Transaction Number";
                dgReport.Columns[4].Name = "Name";
                dgReport.Columns[5].Name = "Sale Value";
                dgReport.Columns[6].Name = "Tax Collected";
            ...
            else if (this.rdoP.Checked)
            {
                ...
                dgReport.Columns[3].Name = "Transaction Number";
                dgReport.Columns[4].Name = "Name";
                dgReport.Columns[5].Name = "Purchase Value";
                dgReport.Columns[6].Name = "Tax Paid";
                subtitle = " - Tax Paid";
            }
            else
            {
                dgReport.ColumnCount = 9;
                dgReport.Columns[0].Name = "Tax Code";
                dgReport.Columns[1].Name = "Description";
                dgReport.Columns[2].Name = "Date";
                dgReport.Columns[3].Name = "Transaction Number";
                dgReport.Columns[4].Name = "Name";
                dgReport.Columns[5].Name = "Sale Value";
                dgReport.Columns[6].Name = "Purchase Value";
                dgReport.Columns[7].Name = "Tax Collected";
                dgReport.Columns[8].Name = "Tax Paid";
                subtitle = "";
            ...
            dgReport.Columns[0].Width = 70;
            dgReport.Columns[1].Width = 150;
        ...
        public decimal TotalPValue(string TaxCode)
        {
            ...
            {
                if (TaxCode == dr["TaxCode"].ToString().Trim())
                {
        ...
        private void btnExportExcell_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog sdf = new SaveFileDialog() { Filter = "Excel Workbook|*.xls", ValidateNames = true })
            {
                if (sdf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    ws.Cells[4, 3] = "Date";
                    ws.Cells[4, 4] = "Transaction Number";
                    ws.Cells[4, 5] = "Name";
                    
                    if (this.rdoC.Checked)
                    {
                        ws.Cells[4, 6] = "Sale Value";
                        ws.Cells[4, 7] = "Tax Collected";
                    }
                    else if (this.rdoP.Checked)
                    {
                        ws.Cells[4, 6] = "Purchase Value";
                        ws.Cells[4, 7] = "Tax Paid";
                    }
                    else
                    {
                        ws.Cells[4, 6] = "Sale Value";
                        ws.Cells[4, 7] = "Purchase Value";
                        ws.Cells[4, 8] = "Tax Collected";
                        ws.Cells[4, 9] = "Tax Paid";
                    }
                    ...
                    foreach (DataGridViewRow item in dgReport.Rows)
                    {
                        ...
                        if (!this.rdoC.Checked && !this.rdoP.Checked)
                        {
                            ...
                            //{
                            //    ws.Cells[i, 7] = item.Cells[9].Value.ToString();
                            //}
                        }
                    ...
                    ws.Cells[1, 1] = "Tax Transactions Detail";
                    ...
                    app.Quit();
                    MessageBox.Show("Tax Transactions Detail has been successfully exported", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    //   this.Close();
                }
            }
        }
