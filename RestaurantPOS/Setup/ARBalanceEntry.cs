    ...
    public partial class ARBalanceEntry : Form
    {
        ...
        private void GenerateHistoricalSalesNo()
        {
            ...
            try
            {
                ...
                connection = new SqlConnection(CommonClass.ConStr);
                connection.Open();
                //string sql = @"SELECT Top 1 SalesNumber, SalesID from Sales where SalesType = 'SINVOICE' order by SalesID desc";
        ...
        private int NewTerm()
         {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@EarlyPaymentDiscountPercent", EarlyPaymenDiscount);
                cmd.Parameters.AddWithValue("@LatePaymentChargePercent", LatePaymenDiscount);
                con.Open();
