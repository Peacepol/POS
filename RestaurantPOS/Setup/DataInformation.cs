        ...
        private void DataInformation_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                    ...
                    && dtainforeader.Read())
                {
                    ...
                    this.lblLogo.Text = (dtainforeader["CompanyLogo"].ToString() != null ? Application.StartupPath + "\\" + dtainforeader["CompanyLogo"].ToString() : dtainforeader["CompanyLogo"].ToString());
