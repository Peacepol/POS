...
{
    public partial class CustomList3 : Form
    {
        ...
        private void LoadList3Suppliers(string pSelected = "")
        {
            int SelIndex = 0;
            lvSup.Items.Clear();
            ...
            try
            {
                ...
                string selectSql = "SELECT * FROM CustomList3 where RecordType = 'Suppliers'";
        ...
        private void LoadList3Customers(string pSelected = "")
        {
            int SelIndex = 0;
            lvCus.Items.Clear();
            ...
            {
                con_ = new SqlConnection(CommonClass.ConStr);
                string selectSql = "SELECT * FROM CustomList3 where RecordType = 'Customers'";
                SqlCommand cmd_ = new SqlCommand(selectSql, con_);
                con_.Open();
        ...
        private void LoadList3Items(string pSelected = "")
        {
            int SelIndex = 0;
            lvItem.Items.Clear();
            ...
            {
                con_ = new SqlConnection(CommonClass.ConStr);
                string selectSql = "SELECT * FROM CustomList3 where RecordType = 'Items'";
                SqlCommand cmd_ = new SqlCommand(selectSql, con_);
                con_.Open();
        ...
        private bool IsDuplicate(string pListName, string pRecordType)
        {
            ...
            {
                con_ = new SqlConnection(CommonClass.ConStr);
                string selectSql = "SELECT * FROM CustomList3 WHERE List3name ='" + pListName + "' and RecordType = '" + pRecordType + "'";
                SqlCommand cmd_ = new SqlCommand(selectSql, con_);
                con_.Open();
        ...
        void New_(string pListName, string pRecordType)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO CustomList3 (RecordType, List3Name) VALUES (@RecordType, @List3Name); SELECT SCOPE_IDENTITY()", con);
                cmd.CommandType = CommandType.Text;

                cmd.Parameters.AddWithValue("@RecordType", pRecordType);
                cmd.Parameters.AddWithValue("@List3Name", pListName);
                ...
                if (rowsaffected != 0)
                {
                    ...
                    {
                        LoadList3Items(rowsaffected.ToString());
                    }
                    if (pRecordType == "Customers")
                    {
                        LoadList3Customers(rowsaffected.ToString());
                    }
                    if (pRecordType == "Suppliers")
                    {
                        LoadList3Suppliers(rowsaffected.ToString());
                    }
                }
            }
            catch (SqlException ex)
        ...
        void UpdateList(string plistID, string plistName, string pRecType)
        {
            ...
            try
            {
                ...
                {
                    con = new SqlConnection(CommonClass.ConStr);
                    SqlCommand cmd = new SqlCommand("Update CustomList3 set List3Name = '" + plistName + "' where id = " + plistID, con);
                    ...
                    if (rowsaffected != 0)
                    {
                        ...
                        {
                            case 0:
                                LoadList3Items(plistID);
                                break;
                            case 1:
                                LoadList3Customers(plistID);
                                break;
                            case 2:
                                LoadList3Suppliers(plistID);
                                break;
                        }
                    }
                }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con = new SqlConnection(CommonClass.ConStr);
                    SqlCommand cmd = new SqlCommand("DELETE FROM CustomList3 where id = " + lListID, con);
        ...
        private void CustomList3_Load(object sender, EventArgs e)
        {
            SetList3Name("Items", ref this.lblItem);
            SetList3Name("Customers", ref this.lblCustomer);
            SetList3Name("Suppliers", ref this.lblSupplier);
            formload();
        }
        ...
        private void SetList3Name(string pRecordType, ref Label plbl)
        {
            SqlConnection con_ = null;
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    plbl.Text = dt.Rows[0]["CList3Name"].ToString();
                }
                else
                {
                    plbl.Text = "";
