...
{
    public partial class RptAgeingSummary : Form
    {
        DataTable TbRep;
        public RptAgeingSummary()
        {
            InitializeComponent();
        ...
        private void RptAgeingSummary_Load(object sender, EventArgs e)
        {
        ...
        private void LoadReportAgeingSummary()
        {
            ...
            try
            {
                ...
                AgeingSummary.ReportName = "AgePayableSummary.rpt";
                AgeingSummary.RptTitle = "Aged Payables [Summary]";
