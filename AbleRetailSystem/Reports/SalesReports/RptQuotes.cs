...
{
    public partial class RptQuotes : Form
    {
 ...
 private bool CanView = false;
        ...
        void LoadReport()
        {
            if (cmbSalesStatus.Text == "Quotes")
            {
                selectSql = @"SELECT TransactionDate, SalesNumber,CustomerPONumber ,
                                    Name,GrandTotal,PromiseDate FROM Sales 
                                INNER JOIN Profile ON Sales.CustomerID = Profile.ID 
                                WHERE TransactionDate BETWEEN @sdate AND @edate 
                                AND InvoiceStatus = 'Quote'";
            }
            ...
            try
            {
                reportName = "SalesQuotes.rpt";
                reportTitle = "Sales Register [Quotes]";
        ...
        private void btnPrintGrid_Click(object sender, EventArgs e)
        {
            ...
            dgPrinter.SubTitle = "Quotes Report";
          ...
          //  dgPrinter.ColumnWidths.Add("ClosedDate", 100);
           dgPrinter.ColumnWidths.Add("GrandTotal",150);
        ...
        private void FormatGrid()
        {
            ...
            this.dgReport.Columns[4].HeaderText = "Amount";
        ...
        private void btnExportExcell_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog sdf = new SaveFileDialog() { Filter = "Excel Workbook|*.xls", ValidateNames = true })
            {
                if (sdf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    ws.Cells[1, 1] = "Sales Quote Report";
                    ...
                    app.Quit();
                    MessageBox.Show("Sales Quote Report has been successfully exported", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
            }
        }

        private void RptQuotes_Load(object sender, EventArgs e)
        {
            if (!CanView)
            {
