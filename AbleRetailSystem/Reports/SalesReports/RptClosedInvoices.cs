...
{
    public partial class RptClosedInvoices : Form
    {
        ...
        void LoadReport()
        {
            ...
            try
            {
                reportName = "ClosedInvoice.rpt";
                reportTitle = "Closed Invoice";
        ...
        private void btnPrintGrid_Click(object sender, EventArgs e)
        {
            ...
            dgPrinter.ColumnWidths.Add("GrandTotal", 180);
            dgPrinter.ColumnWidths.Add("InvoiceStatus", 60);
        ...
        private void FormatGrid()
        {
            ...
            this.dgReport.Columns[5].HeaderText = "Date Closed";
        ...
        private void btnExportExcell_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog sdf = new SaveFileDialog() { Filter = "Excel Workbook|*.xls", ValidateNames = true })
            {
                if (sdf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    ws.Cells[1, 1] = "Closed Invoice Report";
                    ...
                    app.Quit();
                    MessageBox.Show("Closed Invoice Report has been successfully exported", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
            }
        }

        private void RptClosedInvoices_Load(object sender, EventArgs e)
        {
            if (!CanView)
            {
