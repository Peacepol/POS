...
{
    public partial class LayByReportCustomizer : Form
    {
        ...
        void LoadReport()
        {
            selectSql = @"SELECT TransactionDate, 
                            ...
                            WHERE TransactionDate BETWEEN @sdate AND @edate AND InvoiceStatus = 'Lay-By' ";
            if (txtAmountFrom.Text != "")
            {
                selectSql += " AND GrandTotal BETWEEN @amountFrom AND @amountTo ";
            }
            ...
            if (promised == true)
            {
                ...
                reportName = "LayByReport.rpt";
                reportTitle = "Sales Register [Lay-By]";
                ...
                pedate = new DateTime(pedate.Year, pedate.Month, pedate.Day, 00, 00, 00).ToUniversalTime();
                psdate = new DateTime(psdate.Year, psdate.Month, psdate.Day, 23, 59, 59).ToUniversalTime();
            ...
            Dictionary<string, object> param = new Dictionary<string, object>();
                ...
                param.Add("@psdate", psdate);
                param.Add("@pedate", pedate);
            param.Add("@amountFrom", float.Parse( txtAmountFrom.Text));
            param.Add("@amountTo", float.Parse(txtAmountTo.Text));
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            openinvoiceorders.Params = "compname";
            openinvoiceorders.PVals = CommonClass.CompName.Trim();
        ...
        private void btnPrintGrid_Click(object sender, EventArgs e)
        {
            ...
            dgPrinter.SubTitle = "Sales Register [Lay-By]";
        ...
        private void btnExportExcell_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog sdf = new SaveFileDialog() { Filter = "Excel Workbook|*.xls", ValidateNames = true })
            {
                if (sdf.ShowDialog() == DialogResult.OK)
                {
                    ...
                    app.Quit();
                    MessageBox.Show("Lay By Report has been successfully exported", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
            }
        }

        private void LayByReportCustomizer_Load(object sender, EventArgs e)
        {
            if (!CanView)
            {
