...
namespace RestaurantPOS.Inventory
{
    public partial class Categories : Form
    {
        ...
        {
            string saveSql = @"INSERT INTO Category ( MainCategoryID, CategoryCode,Description ,IncomeGLCode, COSGLCode, InventoryGLCode,ItemType)
                                Values (@MainCatID, @CatCode, @Description , @IncomeCode , @CosCode , @InventoryCode , @ItemType )";
        ...
        private int UpdateCategory(string pCatID)
        {
            string updateSql = @"UPDATE Category SET MainCategoryID = @MainCatID ,
                                ...
                                ItemType = @ItemType WHERE CategoryID = " + pCatID;
            Dictionary<string, object> param = new Dictionary<string, object>();
